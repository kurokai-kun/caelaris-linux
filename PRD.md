...
- **Core Technical Specifications:**
  ...
  - **Image Format:** Bootable Hybrid UEFI ARM64 ISO (`caelaris-arm64-pc.iso`) with full live graphical desktop preview and installer on dedicated `arm64-pc-release`.
